...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <img src="${logoBase64}" alt="Aletheia" class="logo">
        ...
        <!-- Footer -->
        <div class="footer">
            <img src="${logoBase64}" alt="Aletheia" class="footer-logo">
            <p>This report was automatically generated by Aletheia</p>
            <p class="powered">Powered by Aletheia • ${currentDate}</p>
        </div>
    </div>
</body>
</html>`;
